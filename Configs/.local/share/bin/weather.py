...
def get_weather_class(weather_code):
    ...
    if code in (200,):
        return "thunder"
    if code in (
        176, 179, 182, 185, 263, 266, 281, 284, 293, 296, 299, 302,
        305, 308, 311, 314, 317, 350, 353, 356, 359, 362, 365, 368, 392
    ):
        return "rain"
    if code in (
        227, 230, 320, 323, 326, 374, 377, 386, 389, 329, 332, 335, 338, 371, 395
    ):
        return "snow"
    return "default"
...
data["class"] = get_weather_class(current_weather["weatherCode"])
